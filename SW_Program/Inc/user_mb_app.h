...
#define     REG_HOLDING_NREGS           64//320
...
#define     HR_MBADDR                       4//( 301u )      // 0x012D Modbus adresas
#define     HR_MBPARITY                     5//( 302u )      // 0x012E Parity
#define     HR_MBBAUDRATE                   6//( 303u )      // 0x012F Bodreito indeksas
#define     HR_MBSTOPBITS                   7//( 304u )      // 0x0130 Stopbitai
